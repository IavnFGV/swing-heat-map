...
Не катастрофа. Но уже достаточно, чтобы перестать мерить производительность выражением лица.

Дальше нагрузка начнёт расти:

- tick можно сделать чаще;
- случайных обновлений можно добавить больше;
- рисование всё ещё остаётся на Swing;
- EDT всё ещё тянет всё на себе;
- а мы всё ещё можем начать гадать, где именно оно заболит.

И вот здесь лучше не делать вид, что мы экстрасенсы.

Следующий шаг — добавить простенький profiler.

## Оставляем тот же ugly heatmap

Важно: heatmap остаётся той же страшненькой штукой из первой версии.

Мы не перескакиваем к красивому проекту, где уже есть отдельные панели, стакан, графики, CVD и маленький зоопарк классов. Это будет другая история.
...
В прототипе нет смысла сразу строить большой dashboard. Выведем всё, что можем быстро замерить, в отдельное окошко:
